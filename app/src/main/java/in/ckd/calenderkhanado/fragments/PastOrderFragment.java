...
import in.ckd.calenderkhanado.activities.ActiveOrderActivtiy;
import in.ckd.calenderkhanado.adapters.OrderStatusAdapter;
...
public class PastOrderFragment extends BaseFragment   implements OrderStatusAdapter.CancelOrderListener
{
    ...
    private List<UserProfileModel.Subscribes>PastsubscribesList = new ArrayList<>();
