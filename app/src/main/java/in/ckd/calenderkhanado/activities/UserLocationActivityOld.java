...
import in.ckd.calenderkhanado.adapters.PlacesRecyclerViewAdapter;
...
public class UserLocationActivityOld extends BaseActivity implements PlacesRecyclerViewAdapter.locationListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainRelativeLocationHolder = (RelativeLayout) findViewById(R.id.mainRelativeLocationHolder);
